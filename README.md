...
One of the many great things about Chaster is its plethora community and intractable lock features. From shared links that other users or gusts can vote to add or remove time on, to verification photos that users vote to verify you are still locked, to even a pillory where users vote to add time or vote on what tasks you should do. Given Chaster's size one might think their is a way to stop certain users from interacting with you and your lock right? Outside of the "ignore conversation" button for user chats their is no way to stop users from interacting with you or your locks. The story is the same for shard locks, a way for users to create and share privately or publicly locks they have created.
