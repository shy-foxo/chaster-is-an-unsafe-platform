...
One of the many great things about Chaster is its community features. Not only does Chaster have a built in chat function it also has many community intractable lock functions. You can create shared links for other users or gusts to add or remove time on your lock, another feature is verification photos. You can submit a photo of yourself locked with a 6 digit code that others can confirm or deny is correct to verify you are still locked. Another popular feature is the pillory. This is a board people can submit polls for people to vote on tasks or people can vote to add more time for other users locks. For getting into the pillory for more time this can either be done automatically if certain conditions are not met or by the keyholder/dom directly.
